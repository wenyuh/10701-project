...
class Quasi_Newton_S3VM:
    ...
    def __init__(self, X_l, y, X_u, class_ratio=-1., lam=1e-4, lam_u=1.,
                 sigma=0.5, kernel="linear", s=3., gamma=20.):
    ...
    def get_predictions(self, X, decision_function=False):
        ...
        if decision_function is True:
            ...
            return predictions, np.sign(predictions).tolist()[0]
